...
function [epsilon,a] = PSO_adam_1(close_price,data,daily_port_past,t,tran_cost,dm,win_size)
rng(0);
...
for iter = 1:max_iterations
    ...
    % Update particle positions and velocities
        ...
        global_best_epsilon = global_best_epsilon + alpha1 *learning_rate_1*grad_1;
        ...
        global_best_a = global_best_a + alpha2*learning_rate_2*grad_2;
